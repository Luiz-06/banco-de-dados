/*19. O nome e a data de nascimento dos funcionários, além do valor de díaria mais cara 
reservada por cada um deles */
...
/*CONSULTA*/
SELECT F.NOME, F.DT_NASC, MAX(C.PRECO) FROM FUNCIONARIO AS F
JOIN RESERVA AS R ON F.COD_FUNC = R.COD_FUNC
JOIN APARTAMENTO AS A ON A.NUM_AP = R.NUM_AP
