...
JOIN HOSPEDE AS HP ON HP.COD_HOSP = R.COD_HOSP
WHERE HP.NOME ILIKE 'JOAO'

UNION 

SELECT F.NOME FROM FUNCIONARIO AS F
JOIN HOSPEDAGEM AS HG ON F.COD_FUNC = HG.COD_FUNC
JOIN HOSPEDE AS HP ON HP.COD_HOSP = HG.COD_HOSP 
WHERE HP.NOME ILIKE 'JOAO'
...
SELECT F.NOME FROM FUNCIONARIO AS F
JOIN RESERVA AS R ON F.COD_FUNC = R.COD_FUNC
JOIN APARTAMENTO AS A ON R.NUM_AP = A.NUM_AP
JOIN CATEGORIA AS C ON A.COD_CAT = C.COD_CAT
WHERE C.NONE ILIKE 'LUXO'
